...
.col-md-4 {
  ...
  margin-bottom: 50px;
	...
	<div id="category-post-section" class="category-post-section" style="  padding-top: 0px;">
		...
		<div style="  background: #EFEEF0; padding: 5px;text-align: center; font-size: 16px;font-weight: bold;">Technology</div>
		<div id="banner-fade1">		
        <ul class="bjqs">
<?php
$row = 1;
if (($handle = fopen("http://localhost:8983/solr/collection1/select?q=category%3ATechnology%0A&sort=last_modified+desc&wt=csv&indent=true", "r")) !== FALSE) 
{  
